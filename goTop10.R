...
goTop10 <- function(choosetype = "artist", howlong = 1) {
    ...
    require(lubridate);require(tidyverse);require(plotly);require(RColorBrewer);require(zoo)
    ...
    print(top10plotly)
    print(top10)
    # Sys.setenv("plotly_username" = "tomcopple")
    # Sys.setenv("plotly_api_key" = "qn5q057aqz")
    # plotly_POST(top10plotly, "lastfm")
